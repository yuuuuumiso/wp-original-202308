<?php get_header(); ?>
  ...
  <main class="main">
    ...
    <section class="sec news">
      <h2 class="secTtl">NEWS<span>通常投稿を表示</span></h2>
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
          ...
          <dd>
            <?php if( has_post_thumbnail() ) : ?>
              <p class="top-thumb"><?php the_post_thumbnail( 'thumbnail' ); ?></p>
                <?php else : ?>
              <p class="top-no-thumb"><img src="<?php echo get_template_directory_uri(); ?>/img/no-img.jpg" width="100" height="auto"></p>
            <?php endif; ?>
            <a href="<?php echo get_permalink(); ?>"><?php echo wp_trim_words( get_the_title(), 38, '…' ); ?></a>
          </dd>
        <?php endwhile; endif;?>
        </dl>
        <a href="<?php echo home_url(); ?>" class="btn btn01 news">もっとみる<i class="fas fa-arrow-circle-right"></i></a>
    </section>

    <section class="sec read">
      <h2 class="secTtl">PLEASE READ<span>ここはなにか出せるようにしたい</span></h2>
    ...
    <section class="sec interview">
      <h2 class="secTtl A">INTERVIEW<span>何かしらの記事を動的に出力する</span></h2>
    ...
    <section class="sec bg2">
      <h2 class="secTtl">CUSTOM TYPE<span>カスタム投稿+カスタムフィールド記事を表示させる</span></h2>
